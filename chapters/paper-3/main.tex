...
\chapter{Polarimetric Analysis of Multi-Seasonal Monostatic and Bistatic Radar Observations of a Dummy Glacier Accumulation Zone at X-Band}
% \blfootnote{
...
\blfootnote{
This chapter is a pre‐print of the above‐listed manuscript, differing from the submitted version only in terms of layout, formatting, and citation style.  
}
